...
export default function PlatformStaffsPage() {
  ...
  async function fetchStaffs() {
    ...
    setError(null);
    try {
      const response = await api.get("/api/platform/staff");
  ...
  async function handleDeleteStaff() {
    ...
    setDeleting(true);
    try {
      await api.delete(`/api/platform/staff/${deletingStaff.id}`);
      setStaffs((prev) =>
                    ...
                    <TableRow key={staff.id}>
                      ...
                      <TableCell>
                        {/* {hasModule(permissions, "managePlatformStaffs") ? ( */}
                          ...
                          {hasAction(user?.permissions, "managePlatformUsers", "update") && (
                            <Button
                              size="icon"
                              variant="outline"
                              aria-label="Edit"
                          ...
                          {hasAction(user?.permissions, "managePlatformUsers", "delete") && (
                            <Button
                              size="icon"
                              variant="destructive"
                              aria-label="Delete"
